...
window.siteName = "Vue Frontend Client"
window.siteUrl = window.location.protocol + '//' + window.location.hostname + (window.location.port ? ':' + window.location.port : '')
let siteInitial = window.siteName.split(' ')[0]
